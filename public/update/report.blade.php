...
<div class="container">
	...
	<div class="tabbable span10">
		<ul class="nav nav-tabs">
			...
			<li class="active"><a href="#generate_weekly" data-toggle="tab">Weekly Report</a></li>
			<li><a href="#generate_control" data-toggle="tab">Generate and Print Report</a></li>
		...
		<div class="tab-content">
			...
			<div class="tab-pane" id="generate_control">
				<p>
	...
	/* $(function() {
		$('#profit').addClass('hideProfit');
		$('#typeSel').change(function() {
			if($('#typeSel').val() == 'profit_loss') {
				$('#profit').removeClass('hideProfit');
				//$('#profit').addClass('showProfit');
			} else {
				$('#profit').addClass('hideProfit');
			}
		});
