...
/***************************Users ***************************************************/
	...
	Public Function getEditExpenses($category_id) {
		$expense = [];
		return View::make('facelift.expensesModal')->with('category', $category_id)->with('expense',$expense);
	}

	Public function postEditExpenses($category_id) {
